...
Une application Web simple pour gérer une liste de tâches (To-Do). Ce projet contient une interface HTML/CSS et un script JavaScript minimal pour ajouter, éditer et supprimer des tâches.
